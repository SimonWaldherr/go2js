module github.com/live-codes/go2js

go 1.17

require (
	github.com/gopherjs/gopherjs v0.0.0-20211101210129-f9bde24e5ca2
...
require (
	...
	github.com/gopherjs/gopherjs.github.io/playground v0.0.0-20211027181711-da251c82ece2 // indirect
